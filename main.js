...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to Daydream! :)\n We aim to make all your daydreams come true, \nNow in order to get started, feel free to either run the 'help' command or use the more user-friendly colored sidebar at your left.\nIn order to skip text rolling, double click/touch anywhere.",
...
var main = (function () {
    ...
    Terminal.prototype.cat = function (cmdComponents) {
        ...
        if (cmdComponents.length <= 1) {
            ...
            var file = files.getInstance()[cmdComponents[1]];
